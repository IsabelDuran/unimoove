...
public interface PlacesApi {
    ...
    ResponseEntity<Void> deletePLace(@ApiParam(value = "By passing in the appropriate place ID, you can delete the place.",required=true) @PathVariable("idPlace") String idPlace
);
    ...
    ResponseEntity<PlaceResponse> getPlace(@ApiParam(value = "By passing in the appropriate place ID, you can get the place.",required=true) @PathVariable("idPlace") String idPlace
);
    ...
    ResponseEntity<Void> modifyPlaceCategory(@ApiParam(value = "",required=true) @PathVariable("idPlace") String idPlace
...
,@ApiParam(value = "The place's new name"  )  @Valid @RequestBody PlaceNameChangeRequest body
    ...
    @RequestMapping(value = "/places",
        produces = { "application/json" }, 
        method = RequestMethod.GET)
    ResponseEntity<List<PlaceResponse>> searchPlace(@ApiParam(value = "the place to be searched") @Valid @RequestParam(value = "name", required = false) String name
);
